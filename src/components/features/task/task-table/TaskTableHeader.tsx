export default function TaskTableHeader() {
  return (
    <header className="flex h-14 w-full items-center justify-between overflow-x-scroll rounded border-y border-ravn-neutral-3 bg-ravn-neutral-4 text-ravn-neutral-1">
