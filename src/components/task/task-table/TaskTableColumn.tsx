    ...
    <div className="flex h-14 w-full items-center justify-between">
      <div className="group relative flex h-full w-full min-w-[460px] items-center justify-between gap-2 overflow-hidden border-x border-b border-ravn-neutral-3 px-4 py-1">
        ...
        <span className="flex h-6 w-6 items-center justify-center">
          <DragIcon className="text-ravn-neutral-2 invisible" />
        </span>
        <div className="flex w-full items-center justify-start gap-2">
          <span className="text-body-m-regular">{zeroPad(task.position)}</span>
          <p className="text-body-m-regular overflow-hidden text-ellipsis whitespace-nowrap">
            {task.name}
          </p>
        </div>

        <div className="flex w-[142px] items-center justify-center gap-2 invisible group-hover:visible">
          <div className="flex items-center justify-center gap-1">
            <p className="text-body-m-regular text-ravn-neutral-1">3</p>
            <CommentIcon />
          </div>
          <div className="flex items-center justify-center gap-1">
            <p className="text-body-m-regular text-ravn-neutral-1">5</p>
            <SubtasksIcon />
          </div>

          <button className="flex items-center justify-center gap-1">
            <p className="text-body-m-regular text-ravn-neutral-1">
              Details
            </p>
            ...
            task.tags.length > 1
              ? (
                <>
                  ...
                  <TechTags className="bg-ravn-neutral-2/10" label={`+${task.tags.length - 1}`} />
                </>
              )
              : <TechTags label={task.tags[0]} />
          }
      ...
      <div className="flex h-full w-full min-w-[140px] items-center justify-start border-b border-r border-ravn-neutral-3 border-r-ravn-neutral-3 px-4 py-2">
        <p className="text-body-m-regular">{POINTS_ESTIMATE[task.pointEstimate]} points</p>
      </div>
